...
public class ProductServiceImpl implements ProductService{
    ...
    public List<Producto> listar() {
        ...
        if (productos == null){
            ...
            productos.add(new Producto(1L, "notebook", "informática", 20));
            productos.add(new Producto(2L, "mesa escritorio", "oficina", 40));
            productos.add(new Producto(3L, "teclado", "informatica", 60));
        }
